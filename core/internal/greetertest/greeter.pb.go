...
const file_greeter_proto_rawDesc = "" +
	"\n" +
	"\rgreeter.proto\x12\vgreetertest\"\"\n" +
	...
	"\aGreeter\x12@\n" +
	"\bSayHello\x12\x19.greetertest.HelloRequest\x1a\x17.greetertest.HelloReply\"\x00B!Z\x1fkyrux/core/internal/greetertestb\x06proto3"
...
var file_greeter_proto_goTypes = []any{
	(*HelloRequest)(nil), // 0: greetertest.HelloRequest
	(*HelloReply)(nil),   // 1: greetertest.HelloReply
}
var file_greeter_proto_depIdxs = []int32{
	0, // 0: greetertest.Greeter.SayHello:input_type -> greetertest.HelloRequest
	1, // 1: greetertest.Greeter.SayHello:output_type -> greetertest.HelloReply
